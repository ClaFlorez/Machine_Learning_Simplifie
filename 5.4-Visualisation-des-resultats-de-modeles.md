...
## 🧩 Frontières de décision – Comparaison de modèles

![Frontières de décision](images/frontieres-de-decision-completes-2D.JPG)
...
![Erreurs du modèle](images/Identifier-ou-et-pourquoi-le-modele-se-trompe.JPG)
...
## 🔑 Importance des variables – Gini vs Permutation Importance

![Importance des Features](images/feature-importance-et-SHAP-values-quelles-variables-influencent -le-plus-predictions.JPG)
...
![Évaluer la qualité des prédictions](images/Evaluer-la-qualite-des-predictions-quantitatives.JPG)
