...
```
# 📘 Chapitre 5.5 – Création et Bonnes Pratiques des Dashboards

Ce chapitre présente un aide-mémoire des commandes essentielles, un exercice guidé pas à pas, une checklist de validation, ainsi que les **bonnes pratiques UX/Performance/Maintenance** pour vos dashboards.  
Enfin, une liste d’outils recommandés pour construire des visualisations efficaces est fournie.

---

## 📝 Aide-mémoire des commandes essentielles

![Commandes de référence](images/5.5-aide-memoire-commandes-essentielles.JPG)

### ⚙️ Setup initial
```bash
mkdir dashboards-ml && cd dashboards-ml
python -m venv venv-dashboards
# Windows
venv-dashboards\Scripts\activate
# Mac/Linux
